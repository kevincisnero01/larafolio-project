<div class="w-full sm:max-w-md px-6 py-4">
    <form wire:submit.prevent="save">
        <div>
            ...
            <x-inputs.text wire:model="currentProject.name" id="name" type="text" required />
        ...
        <div class="mt-3">
            ...
            <x-inputs.textarea wire:model="currentProject.description" id="projectDescription" required />
        ...
        <div class="mt-4">
            ...
            <x-inputs.text wire:model="currentProject.video_link" id="video_link" type="text" />
        ...
        <div class="mt-3">
            ...
            <x-inputs.text wire:model="currentProject.url" id="url" type="text" />
        ...
        <div class="mt-3">
            ...
            <x-inputs.text wire:model="currentProject.repo_url" id="repourl" type="text" />
