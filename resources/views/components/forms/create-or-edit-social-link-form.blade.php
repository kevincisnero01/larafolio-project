<form wire:submit.prevent="save">
    <div>
        ...
        <x-inputs.text wire:model="socialLink.name" id="socialLinkName" type="text" required />
    ...
    <div class="mt-4">
        ...
        <x-inputs.text wire:model="socialLink.url" id="socialLinkUrl" type="text" required />
    ...
    <div class="mt-4">
        ...
        <x-inputs.text wire:model="socialLink.icon" id="icon" placeholder="fa-brands fa-twitter" type="text"/>
